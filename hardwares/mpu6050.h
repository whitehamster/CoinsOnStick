...
#define devAddr  0xD0
//自定义常量
#define gyro_zOFFSET		0.79f			//待测
#define StickLength			0.475f			//待测(米)
#define MPU6050_ONE_G		9.80665f
#define TORAD				(3.14159/180.0f)// 0.01745 rad/deg
#define Gyro1000scale_JD	(32768.0/250.0f)// 131.1 LSB/(deg/sec)
#define Acc1000scale_JD		(32768.0/4.0f)	// 8192 LSB/g
